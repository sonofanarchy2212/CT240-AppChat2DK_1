...
public class ChatFrame extends JFrame {
	...
	public ChatFrame(String username, DataInputStream dis, DataOutputStream dos) {
		...
		btnSend.setIcon(new ImageIcon("src\\data\\icon\\component\\send.png"));
		...
		JLabel orangeIcon = new JLabel(new ImageIcon("src\\data\\icon\\emoji\\orange.png"));
		orangeIcon.addMouseListener(new IconListener(orangeIcon.getIcon().toString()));
		emojis.add(orangeIcon);
		
		JLabel cherryIcon = new JLabel(new ImageIcon("src\\data\\icon\\emoji\\cherry.png"));
		cherryIcon.addMouseListener(new IconListener(cherryIcon.getIcon().toString()));
		emojis.add(cherryIcon);
		
		JLabel cakeIcon = new JLabel(new ImageIcon("src\\data\\icon\\emoji\\cake.png"));
		...
		JLabel usIcon = new JLabel(new ImageIcon("src\\data\\icon\\emoji\\us.png"));
		usIcon.addMouseListener(new IconListener(usIcon.getIcon().toString()));
		emojis.add(usIcon);
		
		JLabel ukIcon = new JLabel(new ImageIcon("src\\data\\icon\\emoji\\uk.png"));
		ukIcon.addMouseListener(new IconListener(ukIcon.getIcon().toString()));
		emojis.add(ukIcon);
		
		JLabel canadaIcon = new JLabel(new ImageIcon("src\\data\\icon\\emoji\\canadaIcon.png"));
		canadaIcon.addMouseListener(new IconListener(canadaIcon.getIcon().toString()));
		emojis.add(canadaIcon);
		
		JLabel italyIcon = new JLabel(new ImageIcon("src\\data\\icon\\emoji\\italy.png"));
		...
		JLabel swedenIcon = new JLabel(new ImageIcon("src\\data\\icon\\emoji\\sweden.png"));
		swedenIcon.addMouseListener(new IconListener(swedenIcon.getIcon().toString()));
		emojis.add(swedenIcon);
		
		JLabel australiaIcon = new JLabel(new ImageIcon("src\\data\\icon\\emoji\\australia.png"));
		australiaIcon.addMouseListener(new IconListener(australiaIcon.getIcon().toString()));
		emojis.add(australiaIcon);
		
		JLabel userImage = new JLabel(new ImageIcon("src\\data\\icon\\component\\user.png"));
